CREATE OR REPLACE VIEW "ANALESTA"."ANE_MER_CONFIG_MERMAS_PLA_OT" AS 
   SELECT MA.EMPRESA, MA.NUMEOTRE, 
          MA.FASESEQU, L.FASE, L.SECUENCI,
          MA.MAQUTIPO, MA.MAQUCODI, 
          MP.IZQUIERD, MP.DERECHA, MP.IZQUIERD + MP.DERECHA MERMA 
